...
from codex_tabs.cli import normalize_tags, validate_name, validate_session_id
...
class ValidationTests(unittest.TestCase):
    ...
    def test_validate_name_rejects_invalid_format(self) -> None:
        with self.assertRaises(ValueError):
            validate_name("Work Main")
